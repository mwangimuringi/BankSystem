...
Partial Class LoanForm
    ...
    ' Variables to store loan information for borrowing
    Private customerNameForLoan As String
    Private accountNumberForLoan As String
    Private loanAmount As Decimal
    Private loanInterest As Decimal

    ' Variables to store loan information for repayment
    Private customerNameForRepayment As String
    Private accountNumberForRepayment As String
    Private loanAmountPaid As Decimal
    Private monthlyInterest As Decimal
    Private totalLoanPaid As Decimal
    ...
    Private Sub ExitLoanButton_Click(sender As Object, e As EventArgs) Handles ExitLoanButton.Click
        ' Add code to handle exiting the loan form
    End Sub
