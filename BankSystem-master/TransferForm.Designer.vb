...
Partial Class TransferForm
    ...
    ' Variables to store transfer information
    Private fromCustomerName As String
    Private fromAccountName As String
    Private fromNICName As String
    Private fromCurrentBalance As Decimal

    Private toCustomerName As String
    Private toAccountName As String
    Private toNICName As String
    Private toCurrentBalance As Decimal
