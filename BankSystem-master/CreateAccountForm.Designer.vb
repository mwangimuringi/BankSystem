...
Partial Class CreateAccountForm
    ...
    Private postalAddress As String = ""
    Private phoneNumber As String = ""
    Private emailAddress As String = ""
    Private occupation As String = ""
    Private initialDeposit As Double = 0.0

    ' Event handler for when the Male radio button is checked
    Private Sub MaleRadioButton_CheckedChanged(sender As Object, e As EventArgs) Handles MaleRadioButton.CheckedChanged
        ' If Male radio button is checked, update the gender variable
        If MaleRadioButton.Checked Then
            gender = "Male"
        End If
    End Sub

    ' Event handler for when the Female radio button is checked
    Private Sub FemaleRadioButton_CheckedChanged(sender As Object, e As EventArgs) Handles FemaleRadioButton.CheckedChanged
        ' If Female radio button is checked, update the gender variable
        If FemaleRadioButton.Checked Then
            gender = "Female"
        End If
    End Sub

    ' Event handler for when the Other radio button is checked
    Private Sub OtherRadioButton_CheckedChanged(sender As Object, e As EventArgs) Handles OtherRadioButton.CheckedChanged
        ' If Other radio button is checked, update the gender variable
        If OtherRadioButton.Checked Then
            gender = "Other"
        End If
    End Sub
    ...
    Private Sub CreateAccountForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ' Set all text boxes and combo boxes to empty or default values
        TextBox1.Text = customerName
        TextBox2.Text = accountNumber
        TextBox3.Text = accountTitle

        ' Set gender radio button according to the gender variable
        Select Case gender
            Case "Male"
            ...
            Case Else
                ' Set a default value if gender is not specified
                MaleRadioButton.Checked = True
        End Select

        ' Set date of birth combo box to default value
        ComboBox2.SelectedIndex = 0


        TextBox5.Text = nationality
        TextBox6.Text = postalAddress
        TextBox9.Text = phoneNumber
        TextBox10.Text = emailAddress

        ' Set occupation combo box to default value
        ComboBox3.SelectedIndex = 0

        ' Set initial deposit text box to zero
        TextBox10.Text = initialDeposit.ToString()
    End Sub
